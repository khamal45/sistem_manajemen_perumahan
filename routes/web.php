...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/house-resident/{house}/residents', [HouseResidentController::class, 'showByHouse'])->name('house_resident.by_house');
    ...
    Route::resource('/pemasukan', FeeTypeController::class);
});
